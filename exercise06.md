...
All of the `git status` commands can be ommitted.

11. Why might it be a bad idea to omit them?

It is a bad idea to ommit them, because those are your confirmation steps to ensure what you are working on is correct and there are no errors.
